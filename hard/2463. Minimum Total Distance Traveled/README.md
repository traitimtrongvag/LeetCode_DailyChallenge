...
unique. The positions of each factory are also 
unique. Note that a robot can be 
...
some robot. Your target is to minimize the total distance traveled by all the robots.
