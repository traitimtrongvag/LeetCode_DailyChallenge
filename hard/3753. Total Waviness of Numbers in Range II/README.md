...
You are given two integers `num1` and `num2` representing an 
inclusive range `[num1, num2]`.

The 
waviness of a number is defined as the total count of its 
peaks and 
valleys
 - A digit is a 
peak if it is 
strictly greater than both of its immediate neighbors.
 ...
 - A digit is a 
valley if it is 
strictly less than both of its immediate neighbors.
