...
A city's 
skyline is the outer contour of the silhouette formed by all the buildings in that city when viewed from a distance. Given the locations and heights of all the buildings, return *the 
...
The 
skyline should be represented as a list of "key points" 
...
### Constraints
- `1 i i i i` in non-decreasing order.
