...
Return* the 
number of the room that held the most meetings. *If there are multiple rooms, return* the room with the 
lowest number.*
...
**Explanation:** - At time 1, all three rooms are not being used. The first meeting starts in room 0.
