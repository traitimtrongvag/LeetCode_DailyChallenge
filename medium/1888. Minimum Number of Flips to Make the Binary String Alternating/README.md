...
flip its value, i.e., if its value is `'0'` it becomes `'1'` and vice-versa.

Return *the 
minimum number of 
type-2 operations you need to perform* *such that *`s` *becomes 
alternating.*

The string is called 
alternating if no two adjacent characters are equal.
